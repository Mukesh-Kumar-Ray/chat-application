      ...
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit(formsubmit)}>
          ...
          <div>
            ...
            <input
              ...
              {...register("username", {
                required: { value: true, message: "pls fill good name..." },
              })}
          ...
          <div>
            ...
            <input
              ...
              {...register("email", {
                required: { value: true, message: "pls fill Email..." },
              })}
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            />
          ...
          <div>
            ...
            <input
              ...
              {...register("password", {
                required: { value: true, message: "pls fill password..." },
              })}
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            />
            <p className="text-sm text-red-500 mt-1">
          ...
          <div>
            ...
            <input
              ...
              {...register("confirmPassword", {
                required: {
                  value: true,
                  message: "pls fill confirmpassword...",
                },
              })}
              className="mt-1 block  w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            />
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <NavLink
              to="/Login"
              className="text-indigo-600 hover:underline focus:outline-none focus:ring-1 focus:ring-indigo-500"
            >
              {" "}
              Login
            </NavLink>
