...
function User({ele}) {
  ...
  <div className="flex items-center space-x-4 px-6 py-4">
    ...
    <div className={isOnline ? (`w-14 h-14 rounded-full overflow-hidden bg-gray-800 ring-2 ring-green-500`):(`w-14 h-14 rounded-full overflow-hidden bg-gray-800 ring-2 ring-red-500`)}>
  <img
